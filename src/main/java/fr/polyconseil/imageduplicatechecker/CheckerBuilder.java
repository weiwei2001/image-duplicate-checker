 ...
 * {@link CheckerBuilder} is created. The created instance is persisted to the
 * project configuration XML by using XStream, so this allows you to use
 * instance fields (like {@link #excludedFolders}) to remember the
 * configuration.
 *
 * <p>
...
public class CheckerBuilder extends Publisher implements SimpleBuildStep {
	...
	public void perform(Run<?, ?> build, FilePath workspace, Launcher launcher, TaskListener listener) {
		FindDuplicates.execute(this.getExcludedFolders(), this.getAllowedFileExtensions(), this.getSourcePathPattern(),
				workspace, listener);
	}
	...
	public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
		 ...
		 *         message
		 */
		public FormValidation doCheckName(@QueryParameter String excludedFolders,
				@QueryParameter String allowedFileExtensions, @QueryParameter String sourcePathPattern)
